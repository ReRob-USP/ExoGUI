...
int mainGUI(){
    ...
    XsensRead = new ThreadExo(new ThreadXsensRead(),"XSens Read 1",1/100.0f,19);
    ...
    MarkovMao1 = new ThreadExo(new ThreadMarkovMao1(),"MarkovMao 1",1/200.0f,13);
    XSENSLeo = new ThreadExo(new ThreadXsensLeo(),"XSens Leo 1",1/100.0f,11);
    return 0;
}
